...
// The function returns a number...
{
	...
	mskmin( x.length, new AccessorArray( x ), 1, new AccessorArray( mask ), 1 ); // $ExpectType number
}
...
// Attached to main export is an `ndarray` method which returns a number...
{
	...
	mskmin.ndarray( x.length, new AccessorArray( x ), 1, 0, new AccessorArray( mask ), 1, 0 ); // $ExpectType number
}
...
// The compiler throws an error if the `ndarray` method is provided a fifth argument which is not a numeric array...
{
	...
	mskmin.ndarray( x.length, x, 1, 0, 10, 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, '10', 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, true, 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, false, 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, null, 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, undefined, 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, [ '1' ], 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, {}, 1, 0 ); // $ExpectError
	mskmin.ndarray( x.length, x, 1, 0, ( x: number ): number => x, 1, 0 ); // $ExpectError
}
